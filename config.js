...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY BALOCH-MD 🤍*",
...
OWNER_NAME: process.env.OWNER_NAME || "BALOCH-MD",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© CREATER BALOCH *",
// add bot owner name    
